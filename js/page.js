...
(function () {
  ...
  if (Modernizr && Modernizr.csstransforms && Modernizr.csstransforms3d && Modernizr.csstransitions) {
    ...
    // Create book elements for each book
    var book1 = document.getElementById("js-book1");
    var book2 = document.getElementById("js-book2");
    var book3 = document.getElementById("js-book3");
    var book4 = document.getElementById("js-book4");
    var book5 = document.getElementById("js-book5");
    var book6 = document.getElementById("js-book6");

    // Add mouseover and mouseout events for each book
    book1.onmouseover = book1.ontouchstart = function () {
      book1.className += " lift-cover";
    };

    book1.onmouseout = book1.ontouchend = function () {
      book1.className = book1.className.replace(/ lift-cover/g, "");
    };

    // Add mouseover and mouseout events for each book
    book2.onmouseover = book2.ontouchstart = function () {
      book2.className += " lift-cover";
    };

    book2.onmouseout = book2.ontouchend = function () {
      book2.className = book2.className.replace(/ lift-cover/g, "");
    };

    // Add mouseover and mouseout events for each book
    book3.onmouseover = book3.ontouchstart = function () {
      book3.className += " lift-cover";
    };

    book3.onmouseout = book3.ontouchend = function () {
      book3.className = book3.className.replace(/ lift-cover/g, "");
    };

    // Add mouseover and mouseout events for each book
    book4.onmouseover = book4.ontouchstart = function () {
      book4.className += " lift-cover";
    };

    book4.onmouseout = book4.ontouchend = function () {
      book4.className = book4.className.replace(/ lift-cover/g, "");
    };

    // Add mouseover and mouseout events for each book
    book5.onmouseover = book5.ontouchstart = function () {
      book5.className += " lift-cover";
    };

    book5.onmouseout = book5.ontouchend = function () {
      book5.className = book5.className.replace(/ lift-cover/g, "");
    };

    // Add mouseover and mouseout events for each book
    book6.onmouseover = book6.ontouchstart = function () {
      book6.className += " lift-cover";
    };

    book6.onmouseout = book6.ontouchend = function () {
      book6.className = book6.className.replace(/ lift-cover/g, "");
    };
